...
object DataFormatting {
  def main(args: Array[String]): Unit = {
    ...
    val load_mob_data = s"""LOAD DATA LOCAL INPATH '/home/acadgild/bhaskar/project/data/mob/file.txt'
    ...
    try {
         val xmlData = sqlContext.read.format("com.databricks.spark.xml").option("rowTag", "record").load("file:///home/acadgild/bhaskar/project/data/web/file.xml")
